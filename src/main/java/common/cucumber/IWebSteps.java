...
public class IWebSteps extends WebSteps{
    ...
    { VerifyExecutedStep(WebSteps.waitForElementToAppear(elementName, AllProducts.getElementSelector(elementName)));
    ...
    {VerifyExecutedStep(WebSteps.waitForElementToAppear(dropDownName, AllProducts.getElementSelector(dropDownName)));
    ...
    {VerifyExecutedStep(WebSteps.waitForElementToAppear(datePickerName, AllProducts.getElementSelector(datePickerName)));
    ...
    { AssertExecutedStep(WebSteps.takeAScreenShot(System.getProperty("reportPath") + "/" + fileName)); }
